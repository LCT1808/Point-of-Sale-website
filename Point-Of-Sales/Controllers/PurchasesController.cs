...
namespace Point_Of_Sales.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        public async Task<IActionResult> Index([FromQuery] string q)
        {
            if (q != null)
            {
                var customerPurchases = await _context.PurchaseHistories.Where(p => p.Customer.Email.Equals(q)).ToListAsync();
        ...
        {
            var customer = _context.Customers.FirstOrDefault(c => c.Email.Equals(order.Customer.Email));
